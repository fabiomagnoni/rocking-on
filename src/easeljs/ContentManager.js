    ...
    this.StartDownload = function () {
        ...
        for (var i = 0; i < 3; i++) {
            ...
            for (var j = 0; j < 3; j++) {
                ...
                SetDownloadParameters(this.imgBackgroundLayers[i][j], "assets/image/Backgrounds/Layer" + i + "_" + j + ".png");
            }
        }

        SetDownloadParameters(this.imgPlayer, "assets/image/Player.png");
        SetDownloadParameters(this.imgMonsterA, "assets/image/MonsterA.png");
        SetDownloadParameters(this.imgMonsterB, "assets/image/MonsterB.png");
        SetDownloadParameters(this.imgMonsterC, "assets/image/MonsterC.png");
        SetDownloadParameters(this.imgMonsterD, "assets/image/MonsterD.png");

        SetDownloadParameters(this.imgInicio, "assets/image/Backgrounds/fundo.png");
        SetDownloadParameters(this.winOverlay, "assets/image/overlays/you_win.png");
        SetDownloadParameters(this.loseOverlay, "assets/image/overlays/you_lose.png");
        SetDownloadParameters(this.diedOverlay, "assets/image/overlays/you_died.png");

        SetDownloadParameters(this.imgBlockA0, "assets/image/Tiles/BlockA0.png");
        SetDownloadParameters(this.imgBlockA1, "assets/image/Tiles/BlockA1.png");
        SetDownloadParameters(this.imgBlockA2, "assets/image/Tiles/BlockA2.png");
        SetDownloadParameters(this.imgBlockA3, "assets/image/Tiles/BlockA3.png");
        SetDownloadParameters(this.imgBlockA4, "assets/image/Tiles/BlockA4.png");
        SetDownloadParameters(this.imgBlockA5, "assets/image/Tiles/BlockA5.png");
        SetDownloadParameters(this.imgBlockA6, "assets/image/Tiles/BlockA6.png");
        SetDownloadParameters(this.imgBlockB0, "assets/image/Tiles/BlockB0.png");
        SetDownloadParameters(this.imgBlockB1, "assets/image/Tiles/BlockB1.png");
        SetDownloadParameters(this.imgGem, "assets/image/Tiles/Gem.png");
        SetDownloadParameters(this.imgExit, "assets/image/Tiles/Exit.png");
        SetDownloadParameters(this.imgPlatform, "assets/image/Tiles/Platform.png");
